...
Label* Assemble::getLabel(const char*&s){
	...
	if(n<3){
		...
		PHTML+="������� ��������� ����� � ������: ";
		PHTML+=SCANER::toString(SCANER::findNumberStringLine(F.text,s));
		PHTML+=SCANER::replaceSpecSumbolHTML(". ������: <label:10>");
		PHTML+="</font><br/>\n";
		return NULL;
		}
	Label*X=new(Label);
...
int Assemble::probaVarRead(const char*&s,L_AL&nabor){
	...
	if(er){
		...
		if(er==1)PHTML+="��� ����� ���������� ����� �������� ���� �� � ������: ";
		if(er==2)PHTML+="��� ������������� ���������� ����� '=' � ������: ";
		if(er==3){PHTML+="��� ��������� ";PHTML+=SCANER::toString(narg);PHTML+=" � ������������, � ������: ";}
		if(er==4)PHTML+="����� ����������� ',' � �������� ���������� � ������: ";
		PHTML+=SCANER::toString(SCANER::findNumberStringLine(F.text,s));
		PHTML+="</font><br/>\n";
		return 2;
...
SpecSumbol* Assemble::getSpecSumbol(const char*&s,int&er){
	...
	if(i>5){
		PHTML+="<font class='red'>";
		PHTML+="����������� ';' ����� '";PHTML+=SpecSumbol::m[i];PHTML+="' � ������: ";
		PHTML+=SCANER::toString(SCANER::findNumberStringLine(F.text,s));
		PHTML+="</font><br/>\n";
		return NULL;
		}
...
WHILE* Assemble::getWHILE(const char*&s,int&er){
	...
	if(SCANER::scanSlovo("do",s)){
		...
		if(er){
			PHTML+="<font class='red'>";
			if(er==1)PHTML+="����� ������ ����� 'do', � ������: ";
			if(er==2)PHTML+="����� ����� 'while' � ����� 'do{}while()', � ������: ";
			if(er==3)PHTML+="��������� '(' � ����� 'do{}while()', � ������: ";
			PHTML+=SCANER::toString(SCANER::findNumberStringLine(F.text,s));
			PHTML+="</font><br/>\n";
			return W;
			}
		...
		if(er){
			PHTML+="<font class='red'>";
			if(er==1)PHTML+="��������� ')' � ����� 'do{}while()', � ������: ";
			if(er==2)PHTML+="����� ������� � ����� 'do{}while(?)', � ������: ";
			if(er==3)PHTML+="��������� ';' ����� ����� 'do{}while()', � ������: ";
			PHTML+=SCANER::toString(SCANER::findNumberStringLine(F.text,s));
			PHTML+="</font><br/>\n";
			}
			...
			if(pos->nfunc==0)if(pos->term=="dynamic_cast"){
				...
				if(er){
					...
					if(er<=4){
						...
						PHTML+=SCANER::replaceSpecSumbolHTML("' � ����� 'dynamic_cast<>()' � ������: ");
						}
					if(er==5){
						PHTML+="������� ������� ��� � ����� ";
						PHTML+=SCANER::replaceSpecSumbolHTML("'dynamic_cast<?>()' � ������: ");
